        ...
        <section className="relative hidden overflow-hidden bg-[#073b4c] p-10 text-white lg:flex lg:flex-col lg:justify-between xl:p-14">
          ...
          <div className="relative z-10">
            ...
            <h1 className="max-w-md text-4xl font-bold leading-tight xl:text-5xl">
              Quản lý cửa hàng thông minh hơn.
            </h1>

            <p className="mt-6 max-w-md text-base leading-7 text-[#c6e4e5]">
              Kết nối sản phẩm, cửa hàng và hoạt động kinh doanh trên một nền
              tảng duy nhất.
            </p>
          </div>
          ...
          <div className="relative z-10">
            <div className="mb-5 flex items-center gap-4">
              ...
              <div>
                <p className="font-semibold">Mọi thứ trong tầm tay</p>
        ...
        <section className="flex items-center justify-center px-5 py-10 sm:px-12 lg:px-16 xl:px-24">
          <div className="w-full max-w-md">
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <label className="flex items-start gap-3 text-sm leading-5 text-[#70858b]">
                <input
                  className="mt-1 h-4 w-4 accent-[#168b87]"
                  type="checkbox"
                  required
                />
                <span>
                  Tôi đồng ý với{" "}
                  <a className="font-semibold text-[#168b87]" href="#">
                    Điều khoản sử dụng
                  </a>{" "}
                  và{" "}
                  <a className="font-semibold text-[#168b87]" href="#">
